<?php
 ...
 $select = "SELECT * FROM transactions_log ORDER BY id DESC";
					...
					<ul>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Transactions </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
								...
								<li><a class="active" href="trans-logs.php"> Transaction log</a></li>
							</ul>
						</li>
												<li class="list-divider"></li>
<li class="submenu"> 
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">All transactions Log</h4>
...
<td align="center"><?php echo $row['trans_type']; ?></td>
<td align="center"><?php echo $row['trans_provider']; ?></td>
<td align="center"><?php echo $row['amount']; ?></td>
<td align="center"><?php echo $row['float_balance']; ?></td>
<td align="center"><?php echo $row['cash_balance']; ?></td>
